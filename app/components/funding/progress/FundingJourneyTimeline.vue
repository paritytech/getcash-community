...
const props = withDefaults(
  defineProps<{
    ...
    /** How many markers are done, on the card's five-step scale. */
...
/**
 * The card scale's completed count projected onto the crypto timeline, by index.
 *
 ...
 * timeline's own second step, crediting its third. The settled count (5) runs past the end,
 ...
 *  nothing complete. The count arrives on the card's five-step scale, so the crypto timeline
 *  projects it down to its own three. */
